        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Donations_Categories_id",
                        column: x => x.id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AllocatedFunds_CashDonations_user",
                        column: x => x.user,
                        principalTable: "CashDonations",
                        principalColumn: "user",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AllocatedFunds_Disaster_TDisaster",
                        column: x => x.TDisaster,
                        principalTable: "Disaster",
                        principalColumn: "TDisaster",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlocatedGoods", x => x.id);
                    table.ForeignKey(
                        name: "FK_AlocatedGoods_Disaster_DisasterId",
                        column: x => x.DisasterId,
                        principalTable: "Disaster",
                        principalColumn: "TDisaster",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AlocatedGoods_Donations_user",
                        column: x => x.user,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AllocatedFunds_TDisaster",
                table: "AllocatedFunds",
                column: "TDisaster");

            migrationBuilder.CreateIndex(
                name: "IX_AllocatedFunds_user",
                table: "AllocatedFunds",
                column: "user");

            migrationBuilder.CreateIndex(
                name: "IX_AlocatedGoods_DisasterId",
                table: "AlocatedGoods",
                column: "DisasterId");

            migrationBuilder.CreateIndex(
                name: "IX_AlocatedGoods_user",
                table: "AlocatedGoods",
                column: "user");
